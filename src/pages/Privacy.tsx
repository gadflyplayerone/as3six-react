      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <br />
            <h2 id="information-we-collect" className="scroll-mt-24"><strong>Information We Collect</strong></h2>
            <ul>
              <li>Contact data (e.g., name, email, phone) when you reach out.</li>
              <li>Usage data (device, pages viewed, approximate location) for analytics.</li>
              <li>Communications you send us (email or forms).</li>
            </ul>
            <br />
            <h2 id="how-we-use-information" className="scroll-mt-24"><strong>How We Use Information</strong></h2>
            <ul>
            ...
            <br />
            <h2 id="sharing" className="scroll-mt-24"><strong>Sharing</strong></h2>
            <p>
              We do not sell personal data. We may share with service providers under contract, or as required by law.
            </p>
            <br />
            <h2 id="retention" className="scroll-mt-24"><strong>Retention</strong></h2>
            <p>
              We retain data only as long as necessary for the purposes above, or to satisfy legal obligations.
            </p>
            <br />
            <h2 id="your-choices" className="scroll-mt-24"><strong>Your Choices</strong></h2>
            <ul>
            ...
            <br />
            <h2 id="contact" className="scroll-mt-24"><strong>Contact</strong></h2>
            <p>
              Questions? Email <a href="mailto:contact@as3six.com">contact@as3six.com</a>.
            </p>
            <br />
            <h2 id="updates" className="scroll-mt-24"><strong>Updates</strong></h2>
